...
Reused by:
  ...
  - ``openspace.entrypoints.mcp.server.search_skills`` — BM25 stage of the MCP search tool
"""
...
# Embedding model — must match cloud embedding generation for cache coherence
